...
with st.sidebar:
    st.markdown(
        ...
        <div class="cyber-logo">
            ...
            <div class="cyber-name">CYBERDHRISTI</div>
...
st.markdown(
    ...
    <div class="cyber-hero">
        ...
        <div class="hero-title">CYBERDHRISTI</div>
        <div class="hero-desc">
...
# =========================================================
    ...
    st.markdown(
        """
        <div class="soc-panel">
            <div class="threat-title">CYBERDHRISTI DATA VAULT</div>
            <div class="threat-desc">
...
st.caption(
    "CYBERDHRISTI // SIH26145 // AI-POWERED NETWORK DEFENSE GRID"
)
